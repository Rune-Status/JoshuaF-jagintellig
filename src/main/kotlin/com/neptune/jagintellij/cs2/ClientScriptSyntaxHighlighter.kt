...
class ClientScriptSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    private val keywords = Arrays.asList(
        ...
        tokens[ClientScriptLexer.WHILE], tokens[ClientScriptLexer.SWITCH], tokens[ClientScriptLexer.SWITCH_TYPE],
        tokens[ClientScriptLexer.CASE], tokens[ClientScriptLexer.DEFAULT]
    )
